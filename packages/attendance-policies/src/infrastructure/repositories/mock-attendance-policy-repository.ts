...
const policyCatalog = [
  ...
  createAttendancePolicy({
    ...
    code: 'field-mobile',
    name: 'Externo livre com auditoria',
    mode: 'field',
    validationStrategy: 'allow',
    geolocationRequired: true,
    photoRequired: true,
    allowOffsiteClocking: true,
    requiresAllowedLocations: false,
    description: 'Libera ponto em campo com foto obrigatória e trilha de auditoria.',
    isActive: true,
    createdAt: now,
    updatedAt: now,
  }),
...
const assignmentsByEmployeeId = new Map(
  [
    ...
    createEmployeeAttendancePolicy({
      ...
      allowAnyLocation: true,
      blockOutsideAllowedLocations: false,
      notes: 'Diego registra em campo com trilha de auditoria e sem revisão.',
      startsAt: '2026-01-01',
      endsAt: null,
      isCurrent: true,
      createdAt: now,

...
const justificationsSeed: Justification[] = [
  {
    ...
    timeRecordId: 'tr-2',
    type: 'late',
    reason: 'Transito intenso devido a acidente na marginal, com comprovante anexado.',
    status: 'pending',
  ...
  },
  {
    ...
    reason: 'Saida registrada com horario incorreto e comprovante do turno anexado.',
    status: 'approved',
  ...
  },
  {
    ...
    timeRecordId: 'tr-5',
    type: 'missing_record',
    reason: 'Declaracao de reuniao externa enviada para incluir entrada que nao foi registrada no app.',
    status: 'pending',
    requestedRecordType: 'entry',
  ...
  },
  {
    ...
    timeRecordId: null,
    type: 'absence',
    reason: 'A colaboradora anexou atestado medico referente a ausencia do dia 02/04.',
    status: 'approved',
  ...
  },
  {
    ...
    timeRecordId: 'tr-10',
    type: 'late',
    reason: 'Atraso por acidente no trajeto, com anexos que nao sustentaram integralmente o horario informado.',
    status: 'rejected',
    requestedRecordType: 'entry',
    requestedRecordedAt: '2026-04-03T12:18:00.000Z',
    reviewedByUserId: 'user-admin-1',
    reviewedAt: '2026-04-03T13:00:00.000Z',
    reviewNotes: 'Justificativa rejeitada por falta de evidencias consistentes para o horario informado.',
  ...
  },
  {
    ...
    timeRecordId: 'tr-6',
    type: 'adjustment_request',
    reason: 'Solicitacao para consolidar ajuste de entrada apos falha no kiosk da recepcao.',
    status: 'pending',
    requestedRecordType: 'entry',
...
const attachmentsSeed: JustificationAttachment[] = [
  {
    ...
    fileUrl: 'https://example.com/comprovante-transito.pdf',
  ...
  },
  {
    ...
    fileUrl: 'https://example.com/declaracao-reuniao-externa.pdf',
    contentType: 'application/pdf',
  ...
  },
  {
    ...
    fileUrl: 'https://example.com/atestado-medico-juliana.pdf',
    contentType: 'application/pdf',
  ...
  },
  {
    ...
    fileUrl: 'https://example.com/foto-kiosk-indisponivel.jpg',
  ...
  {
    id: 'att-5',
    justificationId: 'just-2',
    fileName: 'escala-turno.pdf',
    fileUrl: 'https://example.com/escala-turno.pdf',
    contentType: 'application/pdf',
    fileSizeBytes: 243210,
  ...
  },
  {
    id: 'att-6',
    justificationId: 'just-2',
    fileName: 'print-linha-tempo.jpg',
    fileUrl: 'https://example.com/print-linha-tempo.jpg',
    contentType: 'image/jpeg',
    fileSizeBytes: 162090,
    uploadedByUserId: 'user-employee-1',
    createdAt: '2026-03-31T20:59:00.000Z',
  },
  {
    id: 'att-7',
    justificationId: 'just-5',
    fileName: 'boletim-ocorrencia.pdf',
    fileUrl: 'https://example.com/boletim-ocorrencia.pdf',
    contentType: 'application/pdf',
    fileSizeBytes: 381420,
    uploadedByUserId: 'user-employee-2',
    createdAt: '2026-04-03T12:30:00.000Z',
  },
  {
    id: 'att-8',
    justificationId: 'just-5',
    fileName: 'print-maps-trajeto.png',
    fileUrl: 'https://example.com/print-maps-trajeto.png',
    contentType: 'image/png',
    fileSizeBytes: 174880,
    uploadedByUserId: 'user-employee-2',
    createdAt: '2026-04-03T12:30:00.000Z',
  },
];

...
const timeRecordsSeed: TimeRecord[] = [
  {
    ...
    notes: 'Entrada com 18 minutos de atraso. Solicitada justificativa.',
    isManual: false,
  ...
  },
  {
    ...
    notes: 'Ajuste manual após comprovação de indisponibilidade no kiosk.',
    isManual: true,
    referenceRecordId: null,
    latitude: null,
    longitude: null,
  ...
  },
  {
    ...
    originalRecordedAt: null,
    notes: 'Registro criado manualmente após declaração de reuniao externa.',
    isManual: true,
    referenceRecordId: null,
    latitude: null,
    longitude: null,
  ...
  },
  {
    ...
    originalRecordedAt: null,
    notes: 'Selfie com baixa iluminação. Validação humana solicitada.',
    isManual: false,
    referenceRecordId: null,
    latitude: -23.56415,
    longitude: -46.65242,
